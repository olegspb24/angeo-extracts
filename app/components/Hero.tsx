  ...
  return (
    <section className=\"relative bg-gradient-to-r from-orange-500 to-amber-400 text-white\">
      <div className=\"container mx-auto px-6 py-24 text-center\">
        ...
        <a href=\"#products\" className=\"inline-block bg-white text-orange-600 px-6 py-3 rounded-full font-semibold hover:bg-orange-100 transition\">Explore Products</a>
      </div>
    </section>
  );
}
